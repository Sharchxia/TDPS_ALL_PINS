...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, Encoder_R_A_Pin|Encoder_R_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, Encoder_L_A_Pin|Encoder_L_B_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* tim_icHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(Ultra_1_Echo_GPIO_Port, Ultra_1_Echo_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC6     ------> TIM8_CH1
    */
    HAL_GPIO_DeInit(Ultra_2_Echo_GPIO_Port, Ultra_2_Echo_Pin);
